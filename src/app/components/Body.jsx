...
export default function Body() {
  return (
    <div className='bg-white/95 pb-10 text-black pt-24 shadow-md py-4'>
      <div className="mr-96 ml-20 flex flex-col space-y-8">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold mb-4">Explore, Learn, Celebrate</h2>
          <p className="text-gray-700">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">Join the Royal Experience</h2>
          <p className="text-gray-700">
