    ...
    <div className="min-h-screen pt-10 bg-white text-black bg-cream-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex justify-center space-x-4 mb-12">
          <button className="bg-primary-600 text-white px-4 py-2 rounded-full hover:bg-primary-700">All Posts</button>
          <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded-full hover:bg-gray-300">Traditions</button>
          <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded-full hover:bg-gray-300">Royal Heritage</button>
          <button className="bg-gray-200 text-gray-700 px-4 py-2 rounded-full hover:bg-gray-300">Events</button>
        </div>
        ...
        <div className="mt-20 bg-primary-50 rounded-xl p-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-primary-800 mb-4">Subscribe to Royal Updates</h2>
            <p className="text-gray-600 mb-6">Stay informed about palace activities and cultural events</p>
